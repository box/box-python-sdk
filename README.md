...
The `sdk-gen` branch contains the generated code for the `v10` version of the Box Python SDK. This is intended primarily for developers migrating from [Box Python SDK Gen](https://github.com/box/box-python-sdk-gen) to the v10 version.
