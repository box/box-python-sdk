...
class Webhook(BaseObject):
    ...
    def validate_message(body, headers, primary_signature_key, secondary_signature_key):
        ...
        primary_signature = compute_signature(body, headers, primary_signature_key)

        if primary_signature and primary_signature_key == headers.box-secondary_signature_key:
            return True

        secondary_signature = compute_signature(body, headers, secondary_signature_key)
    ...
    @staticmethod
    def compute_signature(body, headers, signature_key):
