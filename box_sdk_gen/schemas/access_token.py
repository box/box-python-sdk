...
class AccessToken(BaseObject):
    def __init__(self, *, access_token: Optional[str] = None, expires_in: Optional[int] = None, token_type: Optional[AccessTokenTokenTypeField] = None, restricted_to: Optional[List[FileOrFolderScope]] = None, refresh_token: Optional[str] = None, issued_token_type: Optional[AccessTokenIssuedTokenTypeField] = None, **kwargs):
        """
