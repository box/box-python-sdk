...
class ClassificationTemplateFieldsOptionsStaticConfigField(BaseObject):
    def __init__(self, *, classification: Optional[ClassificationTemplateFieldsOptionsStaticConfigClassificationField] = None, **kwargs):
        """
...
class ClassificationTemplateFieldsOptionsField(BaseObject):
    ...
    def __init__(self, id: str, key: str, *, static_config: Optional[ClassificationTemplateFieldsOptionsStaticConfigField] = None, **kwargs):
        """
