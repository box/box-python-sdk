...
class TrashFilePathCollectionEntriesField(BaseObject):
    ...
    def __init__(self, *, type: Optional[TrashFilePathCollectionEntriesTypeField] = None, id: Optional[str] = None, sequence_id: Optional[str] = None, etag: Optional[str] = None, name: Optional[str] = None, **kwargs):
        """
...
class TrashFilePathCollectionField(BaseObject):
    def __init__(self, total_count: int, entries: List[TrashFilePathCollectionEntriesField], **kwargs):
        """
