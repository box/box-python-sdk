...
class GroupMini(GroupBase):
    def __init__(self, id: str, *, name: Optional[str] = None, group_type: Optional[GroupMiniGroupTypeField] = None, type: GroupBaseTypeField = GroupBaseTypeField.GROUP, **kwargs):
        """
