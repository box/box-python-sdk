...
class ItemsOffsetPaginatedOrderField(BaseObject):
    def __init__(self, *, by: Optional[str] = None, direction: Optional[ItemsOffsetPaginatedOrderDirectionField] = None, **kwargs):
        """
...
class ItemsOffsetPaginated(BaseObject):
    def __init__(self, *, total_count: Optional[int] = None, limit: Optional[int] = None, offset: Optional[int] = None, order: Optional[List[ItemsOffsetPaginatedOrderField]] = None, entries: Optional[List[Union[FileFull, FolderMini, WebLink]]] = None, **kwargs):
        """
