...
class MetadataTemplateFieldsField(BaseObject):
    ...
    _discriminator = 'type', {'string', 'float', 'date', 'enum', 'multiSelect', 'integer'}
    def __init__(self, type: MetadataTemplateFieldsTypeField, key: str, display_name: str, *, description: Optional[str] = None, hidden: Optional[bool] = None, options: Optional[List[MetadataTemplateFieldsOptionsField]] = None, id: Optional[str] = None, **kwargs):
        """
...
class MetadataTemplate(BaseObject):
    ...
    def __init__(self, id: str, *, type: MetadataTemplateTypeField = MetadataTemplateTypeField.METADATA_TEMPLATE, scope: Optional[str] = None, template_key: Optional[str] = None, display_name: Optional[str] = None, hidden: Optional[bool] = None, fields: Optional[List[MetadataTemplateFieldsField]] = None, copy_instance_on_item_copy: Optional[bool] = None, **kwargs):
        """
