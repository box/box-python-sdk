...
class AiStudioAgentAskResponse(BaseObject):
    ...
    def __init__(self, access_state: str, description: str, *, type: AiStudioAgentAskResponseTypeField = AiStudioAgentAskResponseTypeField.AI_AGENT_ASK, custom_instructions: Optional[str] = None, long_text: Optional[AiStudioAgentLongTextToolResponse] = None, basic_text: Optional[AiStudioAgentBasicTextToolResponse] = None, long_text_multi: Optional[AiStudioAgentLongTextToolResponse] = None, basic_text_multi: Optional[AiStudioAgentBasicTextToolResponse] = None, **kwargs):
        """
