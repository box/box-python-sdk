...
class MetadataTaxonomies(BaseObject):
    def __init__(
        self,
        *,
        ...
        entries: Optional[List[MetadataTaxonomy]] = None,
        **kwargs
    ):
        """
        ...
        allowed. The maximum value varies by API., defaults to None
                ...
                :param entries: A list of metadata taxonomies., defaults to None
                :type entries: Optional[List[MetadataTaxonomy]], optional
        """
