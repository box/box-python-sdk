...
class TermsOfServiceEnterpriseField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[TermsOfServiceEnterpriseTypeField] = None, name: Optional[str] = None, **kwargs):
        """
...
class TermsOfService(TermsOfServiceBase):
    def __init__(self, id: str, *, status: Optional[TermsOfServiceStatusField] = None, enterprise: Optional[TermsOfServiceEnterpriseField] = None, tos_type: Optional[TermsOfServiceTosTypeField] = None, text: Optional[str] = None, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, type: TermsOfServiceBaseTypeField = TermsOfServiceBaseTypeField.TERMS_OF_SERVICE, **kwargs):
        """
