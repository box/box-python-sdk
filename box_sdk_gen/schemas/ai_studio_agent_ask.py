...
class AiStudioAgentAsk(BaseObject):
    ...
    def __init__(self, access_state: str, description: str, *, type: AiStudioAgentAskTypeField = AiStudioAgentAskTypeField.AI_AGENT_ASK, custom_instructions: Optional[str] = None, long_text: Optional[AiStudioAgentLongTextTool] = None, basic_text: Optional[AiStudioAgentBasicTextTool] = None, long_text_multi: Optional[AiStudioAgentLongTextTool] = None, basic_text_multi: Optional[AiStudioAgentBasicTextTool] = None, **kwargs):
        """
