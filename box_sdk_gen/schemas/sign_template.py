...
class SignTemplateAdditionalInfoRequiredField(BaseObject):
    def __init__(self, *, signers: Optional[List[List[SignTemplateAdditionalInfoRequiredSignersField]]] = None, **kwargs):
        """
...
class SignTemplateAdditionalInfoField(BaseObject):
    def __init__(self, *, non_editable: Optional[List[SignTemplateAdditionalInfoNonEditableField]] = None, required: Optional[SignTemplateAdditionalInfoRequiredField] = None, **kwargs):
        """
