...
class CommentsOrderField(BaseObject):
    def __init__(self, *, by: Optional[str] = None, direction: Optional[CommentsOrderDirectionField] = None, **kwargs):
        """
...
class Comments(BaseObject):
    def __init__(self, *, total_count: Optional[int] = None, limit: Optional[int] = None, offset: Optional[int] = None, order: Optional[List[CommentsOrderField]] = None, entries: Optional[List[CommentFull]] = None, **kwargs):
        """
