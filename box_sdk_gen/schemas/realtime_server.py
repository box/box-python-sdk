...
class RealtimeServer(BaseObject):
    def __init__(self, *, type: Optional[str] = None, url: Optional[str] = None, ttl: Optional[str] = None, max_retries: Optional[str] = None, retry_timeout: Optional[int] = None, **kwargs):
        """
