...
class IntegrationMappingPartnerItemSlack(BaseObject):
    ...
    def __init__(self, id: str, *, type: IntegrationMappingPartnerItemSlackTypeField = IntegrationMappingPartnerItemSlackTypeField.CHANNEL, slack_workspace_id: Optional[str] = None, slack_org_id: Optional[str] = None, **kwargs):
        """
