...
from box_sdk_gen.schemas.file_request_update_request import FileRequestUpdateRequestStatusField
...
class FileRequestCopyRequestFolderField(BaseObject):
    ...
    def __init__(self, id: str, *, type: Optional[FileRequestCopyRequestFolderTypeField] = None, **kwargs):
        """
...
class FileRequestCopyRequest(FileRequestUpdateRequest):
    def __init__(self, folder: FileRequestCopyRequestFolderField, *, title: Optional[str] = None, description: Optional[str] = None, status: Optional[FileRequestUpdateRequestStatusField] = None, is_email_required: Optional[bool] = None, is_description_required: Optional[bool] = None, expires_at: Optional[DateTime] = None, **kwargs):
        """
