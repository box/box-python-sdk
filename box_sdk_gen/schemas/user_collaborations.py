...
class UserCollaborations(UserBase):
    def __init__(self, id: str, *, name: Optional[str] = None, login: Optional[str] = None, is_active: Optional[bool] = None, type: UserBaseTypeField = UserBaseTypeField.USER, **kwargs):
        """
