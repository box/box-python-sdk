...
class CollaborationAllowlistEntryEnterpriseField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[CollaborationAllowlistEntryEnterpriseTypeField] = None, name: Optional[str] = None, **kwargs):
        """
...
class CollaborationAllowlistEntry(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[CollaborationAllowlistEntryTypeField] = None, domain: Optional[str] = None, direction: Optional[CollaborationAllowlistEntryDirectionField] = None, enterprise: Optional[CollaborationAllowlistEntryEnterpriseField] = None, created_at: Optional[DateTime] = None, **kwargs):
        """
