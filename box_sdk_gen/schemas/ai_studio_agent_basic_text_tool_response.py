...
from box_sdk_gen.schemas.ai_studio_agent_basic_text_tool import AiStudioAgentBasicTextTool

from box_sdk_gen.box.errors import BoxSDKError

class AiStudioAgentBasicTextToolResponse(AiStudioAgentBasicTextTool):
    def __init__(self, *, warnings: Optional[List[str]] = None, is_custom_instructions_included: Optional[bool] = None, system_message: Optional[str] = None, prompt_template: Optional[str] = None, model: Optional[str] = None, num_tokens_for_completion: Optional[int] = None, llm_endpoint_params: Optional[AiLlmEndpointParams] = None, **kwargs):
        """
...
`{current_date}` is optional, depending on the use., defaults to None
        ...
        """
        super().__init__(is_custom_instructions_included=is_custom_instructions_included, system_message=system_message, prompt_template=prompt_template, model=model, num_tokens_for_completion=num_tokens_for_completion, llm_endpoint_params=llm_endpoint_params, **kwargs)
