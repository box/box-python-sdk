...
class KeywordSkillCardSkillField(BaseObject):
    ...
    def __init__(self, id: str, *, type: KeywordSkillCardSkillTypeField = KeywordSkillCardSkillTypeField.SERVICE, **kwargs):
        """
...
class KeywordSkillCardInvocationField(BaseObject):
    ...
    def __init__(self, id: str, *, type: KeywordSkillCardInvocationTypeField = KeywordSkillCardInvocationTypeField.SKILL_INVOCATION, **kwargs):
        """
...
class KeywordSkillCard(BaseObject):
    ...
    def __init__(self, skill: KeywordSkillCardSkillField, invocation: KeywordSkillCardInvocationField, entries: List[KeywordSkillCardEntriesField], *, created_at: Optional[DateTime] = None, type: KeywordSkillCardTypeField = KeywordSkillCardTypeField.SKILL_CARD, skill_card_type: KeywordSkillCardSkillCardTypeField = KeywordSkillCardSkillCardTypeField.KEYWORD, skill_card_title: Optional[KeywordSkillCardSkillCardTitleField] = None, **kwargs):
        """
