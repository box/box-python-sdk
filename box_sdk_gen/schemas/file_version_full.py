...
class FileVersionFull(FileVersion):
    def __init__(self, id: str, *, version_number: Optional[str] = None, name: Optional[str] = None, size: Optional[int] = None, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, modified_by: Optional[UserMini] = None, trashed_at: Optional[DateTime] = None, trashed_by: Optional[UserMini] = None, restored_at: Optional[DateTime] = None, restored_by: Optional[UserMini] = None, purged_at: Optional[DateTime] = None, uploader_display_name: Optional[str] = None, sha_1: Optional[str] = None, type: FileVersionBaseTypeField = FileVersionBaseTypeField.FILE_VERSION, **kwargs):
        """
        ...
        """
        super().__init__(id=id, name=name, size=size, created_at=created_at, modified_at=modified_at, modified_by=modified_by, trashed_at=trashed_at, trashed_by=trashed_by, restored_at=restored_at, restored_by=restored_by, purged_at=purged_at, uploader_display_name=uploader_display_name, sha_1=sha_1, type=type, **kwargs)
