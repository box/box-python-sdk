...
class AiLlmEndpointParamsOpenAi(BaseObject):
    ...
    def __init__(self, *, type: AiLlmEndpointParamsOpenAiTypeField = AiLlmEndpointParamsOpenAiTypeField.OPENAI_PARAMS, temperature: Optional[float] = None, top_p: Optional[float] = None, frequency_penalty: Optional[float] = None, presence_penalty: Optional[float] = None, stop: Optional[str] = None, **kwargs):
        """
