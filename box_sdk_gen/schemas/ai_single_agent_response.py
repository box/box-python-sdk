...
class AiSingleAgentResponse(BaseObject):
    ...
    def __init__(self, id: str, origin: str, name: str, access_state: str, *, type: Optional[AiSingleAgentResponseTypeField] = None, created_by: Optional[UserBase] = None, created_at: Optional[DateTime] = None, modified_by: Optional[UserBase] = None, modified_at: Optional[DateTime] = None, icon_reference: Optional[str] = None, allowed_entities: Optional[List[AiAgentAllowedEntity]] = None, **kwargs):
        """
