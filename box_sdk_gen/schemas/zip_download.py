...
class ZipDownloadNameConflictsField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[ZipDownloadNameConflictsTypeField] = None, original_name: Optional[str] = None, download_name: Optional[str] = None, **kwargs):
        """
