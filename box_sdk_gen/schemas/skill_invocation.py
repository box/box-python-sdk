...
class SkillInvocationSkillField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[SkillInvocationSkillTypeField] = None, name: Optional[str] = None, api_key: Optional[str] = None, **kwargs):
        """
...
class SkillInvocationTokenReadField(BaseObject):
    def __init__(self, *, access_token: Optional[str] = None, expires_in: Optional[int] = None, token_type: Optional[SkillInvocationTokenReadTokenTypeField] = None, restricted_to: Optional[str] = None, **kwargs):
        """
...
class SkillInvocationTokenField(BaseObject):
    def __init__(self, *, read: Optional[SkillInvocationTokenReadField] = None, write: Optional[SkillInvocationTokenWriteField] = None, **kwargs):
        """
...
class SkillInvocationStatusField(BaseObject):
    def __init__(self, *, state: Optional[SkillInvocationStatusStateField] = None, message: Optional[str] = None, error_code: Optional[str] = None, additional_info: Optional[str] = None, **kwargs):
        """
...
class SkillInvocationEnterpriseField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[SkillInvocationEnterpriseTypeField] = None, name: Optional[str] = None, **kwargs):
        """
...
class SkillInvocation(BaseObject):
    ...
    def __init__(self, *, type: Optional[SkillInvocationTypeField] = None, id: Optional[str] = None, skill: Optional[SkillInvocationSkillField] = None, token: Optional[SkillInvocationTokenField] = None, status: Optional[SkillInvocationStatusField] = None, created_at: Optional[DateTime] = None, trigger: Optional[str] = None, enterprise: Optional[SkillInvocationEnterpriseField] = None, source: Optional[Union[File, Folder]] = None, event: Optional[Event] = None, **kwargs):
        """
