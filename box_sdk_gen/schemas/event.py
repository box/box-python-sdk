...
class EventEventTypeField(str, Enum):
    ...
    EDR_CROWDSTRIKE_ACCESS_ALLOWED_NO_CROWDSTRIKE_DEVICE = 'EDR_CROWDSTRIKE_ACCESS_ALLOWED_NO_CROWDSTRIKE_DEVICE'
...
class Event(BaseObject):
    def __init__(self, *, type: Optional[str] = None, created_at: Optional[DateTime] = None, recorded_at: Optional[DateTime] = None, event_id: Optional[str] = None, created_by: Optional[UserMini] = None, event_type: Optional[EventEventTypeField] = None, session_id: Optional[str] = None, source: Optional[Union[User, EventSource, File, Folder, Dict, AppItemEventSource]] = None, additional_details: Optional[EventAdditionalDetailsField] = None, **kwargs):
        """
