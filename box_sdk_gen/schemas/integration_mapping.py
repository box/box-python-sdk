...
class IntegrationMapping(IntegrationMappingBase):
    def __init__(self, partner_item: Union[IntegrationMappingPartnerItemSlack], box_item: FolderMini, id: str, *, integration_type: Optional[IntegrationMappingIntegrationTypeField] = None, is_manually_created: Optional[bool] = None, options: Optional[IntegrationMappingSlackOptions] = None, created_by: Optional[UserIntegrationMappings] = None, modified_by: Optional[UserIntegrationMappings] = None, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, type: IntegrationMappingBaseTypeField = IntegrationMappingBaseTypeField.INTEGRATION_MAPPING, **kwargs):
        """
