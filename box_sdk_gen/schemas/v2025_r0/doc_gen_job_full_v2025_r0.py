...
from box_sdk_gen.schemas.v2025_r0.doc_gen_job_base_v2025_r0 import DocGenJobBaseV2025R0TypeField
...
from box_sdk_gen.schemas.v2025_r0.doc_gen_job_v2025_r0 import DocGenJobV2025R0StatusField
...
class DocGenJobFullV2025R0(DocGenJobV2025R0):
    def __init__(self, created_by: UserBaseV2025R0, enterprise: EnterpriseReferenceV2025R0, source: str, batch: DocGenBatchBaseV2025R0, template_file: FileReferenceV2025R0, template_file_version: FileVersionBaseV2025R0, status: DocGenJobV2025R0StatusField, output_type: str, id: str, *, created_at: Optional[str] = None, output_file: Optional[Optional[FileReferenceV2025R0]] = None, output_file_version: Optional[Optional[FileVersionBaseV2025R0]] = None, type: DocGenJobBaseV2025R0TypeField = DocGenJobBaseV2025R0TypeField.DOCGEN_JOB, **kwargs):
        ...
        """
        super().__init__(batch=batch, template_file=template_file, template_file_version=template_file_version, status=status, output_type=output_type, id=id, output_file=output_file, output_file_version=output_file_version, type=type, **kwargs)
