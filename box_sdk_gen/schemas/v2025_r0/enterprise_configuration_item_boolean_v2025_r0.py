...
class EnterpriseConfigurationItemBooleanV2025R0(EnterpriseConfigurationItemV2025R0):
    def __init__(
        self, *, value: Optional[bool] = None, is_used: Optional[bool] = None, **kwargs
    ):
        """
        :param value: The value of the enterprise configuration as a boolean., defaults to None
