...
class ClientErrorV2025R0(BaseObject):
    ...
    def __init__(self, *, type: Optional[ClientErrorV2025R0TypeField] = None, status: Optional[int] = None, code: Optional[ClientErrorV2025R0CodeField] = None, message: Optional[str] = None, context_info: Optional[ClientErrorV2025R0ContextInfoField] = None, help_url: Optional[str] = None, request_id: Optional[str] = None, **kwargs):
        """
