...
class DocGenBatchCreateRequestV2025R0DestinationFolderField(BaseObject):
    ...
    def __init__(self, id: str, *, type: DocGenBatchCreateRequestV2025R0DestinationFolderTypeField = DocGenBatchCreateRequestV2025R0DestinationFolderTypeField.FOLDER, **kwargs):
        """
...
class DocGenBatchCreateRequestV2025R0(BaseObject):
    def __init__(self, file: FileReferenceV2025R0, input_source: str, destination_folder: DocGenBatchCreateRequestV2025R0DestinationFolderField, output_type: str, document_generation_data: List[DocGenDocumentGenerationDataV2025R0], *, file_version: Optional[FileVersionBaseV2025R0] = None, **kwargs):
        """
