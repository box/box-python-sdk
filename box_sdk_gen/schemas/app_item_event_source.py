...
class AppItemEventSource(BaseObject):
    ...
    def __init__(self, id: str, app_item_type: str, *, type: AppItemEventSourceTypeField = AppItemEventSourceTypeField.APP_ITEM, user: Optional[UserMini] = None, group: Optional[GroupMini] = None, **kwargs):
        """
