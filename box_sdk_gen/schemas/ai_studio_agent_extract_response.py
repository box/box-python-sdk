...
from box_sdk_gen.schemas.ai_studio_agent_long_text_tool_response import AiStudioAgentLongTextToolResponse

from box_sdk_gen.schemas.ai_studio_agent_basic_text_tool_response import AiStudioAgentBasicTextToolResponse
...
class AiStudioAgentExtractResponse(BaseObject):
    ...
    def __init__(self, access_state: str, description: str, *, type: AiStudioAgentExtractResponseTypeField = AiStudioAgentExtractResponseTypeField.AI_AGENT_EXTRACT, custom_instructions: Optional[str] = None, long_text: Optional[AiStudioAgentLongTextToolResponse] = None, basic_text: Optional[AiStudioAgentBasicTextToolResponse] = None, **kwargs):
        """
