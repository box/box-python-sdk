...
class MetadataTaxonomyNodes(BaseObject):
    def __init__(
        self,
        *,
        ...
        entries: Optional[List[MetadataTaxonomyNode]] = None,
        **kwargs
    ):
        """
        ...
        allowed. The maximum value varies by API., defaults to None
                ...
                :param entries: A list of metadata taxonomy nodes., defaults to None
                :type entries: Optional[List[MetadataTaxonomyNode]], optional
        """
