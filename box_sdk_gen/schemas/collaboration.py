...
class CollaborationAcceptanceRequirementsStatusTermsOfServiceRequirementField(BaseObject):
...
class CollaborationAcceptanceRequirementsStatusStrongPasswordRequirementField(BaseObject):
...
class CollaborationAcceptanceRequirementsStatusTwoFactorAuthenticationRequirementField(BaseObject):
