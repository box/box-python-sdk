...
class WorkflowFull(Workflow):
    def __init__(self, *, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, created_by: Optional[UserBase] = None, modified_by: Optional[UserBase] = None, flows: Optional[List[WorkflowFlowsField]] = None, id: Optional[str] = None, type: Optional[WorkflowMiniTypeField] = None, name: Optional[str] = None, description: Optional[str] = None, is_enabled: Optional[bool] = None, **kwargs):
        """
