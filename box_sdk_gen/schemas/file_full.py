...
class FileFullPermissionsField(BaseObject):
    def __init__(self, can_delete: bool, can_download: bool, can_invite_collaborator: bool, can_rename: bool, can_set_share_access: bool, can_share: bool, can_annotate: bool, can_comment: bool, can_preview: bool, can_upload: bool, can_view_annotations_all: bool, can_view_annotations_self: bool, **kwargs):
        """
...
class FileFullLockField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[FileFullLockTypeField] = None, created_by: Optional[UserMini] = None, created_at: Optional[DateTime] = None, expired_at: Optional[DateTime] = None, is_download_prevented: Optional[bool] = None, app_type: Optional[FileFullLockAppTypeField] = None, **kwargs):
        """
...
class FileFullExpiringEmbedLinkField(BaseObject):
    def __init__(self, *, access_token: Optional[str] = None, expires_in: Optional[int] = None, token_type: Optional[FileFullExpiringEmbedLinkTokenTypeField] = None, restricted_to: Optional[List[FileOrFolderScope]] = None, url: Optional[str] = None, **kwargs):
        """
...
class FileFullRepresentationsEntriesPropertiesField(BaseObject):
    def __init__(self, *, dimensions: Optional[str] = None, paged: Optional[str] = None, thumb: Optional[str] = None, **kwargs):
        """
...
class FileFullRepresentationsEntriesStatusField(BaseObject):
    def __init__(self, *, state: Optional[FileFullRepresentationsEntriesStatusStateField] = None, **kwargs):
        """
...
class FileFullRepresentationsField(BaseObject):
    def __init__(self, *, entries: Optional[List[FileFullRepresentationsEntriesField]] = None, **kwargs):
        """
...
perform changes on the file if (no) changes have happened., defaults to None
        ...
        """
        super().__init__(id=id, description=description, size=size, path_collection=path_collection, created_at=created_at, modified_at=modified_at, trashed_at=trashed_at, purged_at=purged_at, content_created_at=content_created_at, content_modified_at=content_modified_at, created_by=created_by, modified_by=modified_by, owned_by=owned_by, shared_link=shared_link, parent=parent, item_status=item_status, sequence_id=sequence_id, name=name, sha_1=sha_1, file_version=file_version, etag=etag, type=type, **kwargs)
