...
class SearchResults(BaseObject):
    ...
    def __init__(self, *, total_count: Optional[int] = None, limit: Optional[int] = None, offset: Optional[int] = None, type: SearchResultsTypeField = SearchResultsTypeField.SEARCH_RESULTS_ITEMS, entries: Optional[List[Union[FileFull, FolderFull, WebLink]]] = None, **kwargs):
        """
