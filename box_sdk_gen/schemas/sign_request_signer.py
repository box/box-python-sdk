...
class SignRequestSignerSignerDecisionField(BaseObject):
    ...
    def __init__(self, *, type: Optional[SignRequestSignerSignerDecisionTypeField] = None, finalized_at: Optional[DateTime] = None, additional_info: Optional[str] = None, **kwargs):
        """
...
instead for signers in the same signer group., defaults to None
        ...
        """
        super().__init__(email=email, role=role, is_in_person=is_in_person, order=order, embed_url_external_user_id=embed_url_external_user_id, redirect_url=redirect_url, declined_redirect_url=declined_redirect_url, login_required=login_required, verification_phone_number=verification_phone_number, password=password, signer_group_id=signer_group_id, suppress_notifications=suppress_notifications, **kwargs)
