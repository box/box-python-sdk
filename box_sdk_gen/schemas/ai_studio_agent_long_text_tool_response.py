...
`{current_date}` is optional, depending on the use., defaults to None
        ...
        """
        super().__init__(is_custom_instructions_included=is_custom_instructions_included, embeddings=embeddings, system_message=system_message, prompt_template=prompt_template, model=model, num_tokens_for_completion=num_tokens_for_completion, llm_endpoint_params=llm_endpoint_params, **kwargs)
