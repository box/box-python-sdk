...
from box_sdk_gen.schemas.ai_agent_long_text_tool import AiAgentLongTextToolEmbeddingsField
...
class AiStudioAgentLongTextTool(AiAgentLongTextTool):
    def __init__(self, *, is_custom_instructions_included: Optional[bool] = None, embeddings: Optional[AiAgentLongTextToolEmbeddingsField] = None, system_message: Optional[str] = None, prompt_template: Optional[str] = None, model: Optional[str] = None, num_tokens_for_completion: Optional[int] = None, llm_endpoint_params: Optional[AiLlmEndpointParams] = None, **kwargs):
        """
