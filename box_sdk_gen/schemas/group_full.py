...
class GroupFull(Group):
    def __init__(self, id: str, *, provenance: Optional[str] = None, external_sync_identifier: Optional[str] = None, description: Optional[str] = None, invitability_level: Optional[GroupFullInvitabilityLevelField] = None, member_viewability_level: Optional[GroupFullMemberViewabilityLevelField] = None, permissions: Optional[GroupFullPermissionsField] = None, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, name: Optional[str] = None, group_type: Optional[GroupMiniGroupTypeField] = None, type: GroupBaseTypeField = GroupBaseTypeField.GROUP, **kwargs):
        """
...
* `all_managed_users` - all managed users in the
  enterprise, defaults to None
        ...
        """
        super().__init__(id=id, created_at=created_at, modified_at=modified_at, name=name, group_type=group_type, type=type, **kwargs)
