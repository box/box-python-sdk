...
class Group(GroupMini):
    def __init__(self, id: str, *, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, name: Optional[str] = None, group_type: Optional[GroupMiniGroupTypeField] = None, type: GroupBaseTypeField = GroupBaseTypeField.GROUP, **kwargs):
        """
