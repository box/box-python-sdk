...
class MetadataQueryOrderByField(BaseObject):
    def __init__(self, *, field_key: Optional[str] = None, direction: Optional[MetadataQueryOrderByDirectionField] = None, **kwargs):
        """
...
class MetadataQuery(BaseObject):
    ...
    def __init__(self, from_: str, ancestor_folder_id: str, *, query: Optional[str] = None, query_params: Optional[Dict] = None, order_by: Optional[List[MetadataQueryOrderByField]] = None, limit: Optional[int] = None, marker: Optional[str] = None, fields: Optional[List[str]] = None, **kwargs):
        """
