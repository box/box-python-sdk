...
class FolderFolderUploadEmailField(BaseObject):
    def __init__(self, *, access: Optional[FolderFolderUploadEmailAccessField] = None, email: Optional[str] = None, **kwargs):
        """
...
perform changes on the folder if (no) changes have happened., defaults to None
        ...
        """
        super().__init__(id=id, sequence_id=sequence_id, name=name, etag=etag, type=type, **kwargs)
