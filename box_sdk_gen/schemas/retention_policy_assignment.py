...
class RetentionPolicyAssignmentAssignedToField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[RetentionPolicyAssignmentAssignedToTypeField] = None, **kwargs):
        """
