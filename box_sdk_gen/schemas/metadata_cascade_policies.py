...
class MetadataCascadePolicies(BaseObject):
    def __init__(self, *, limit: Optional[int] = None, next_marker: Optional[str] = None, prev_marker: Optional[str] = None, entries: Optional[List[MetadataCascadePolicy]] = None, **kwargs):
        """
