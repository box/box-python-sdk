...
headers., defaults to None
        ...
        """
        super().__init__(id=id, url=url, sequence_id=sequence_id, name=name, type=type, etag=etag, **kwargs)
        self.parent = parent
