...
class CompletionRuleVariable(BaseObject):
    ...
    def __init__(self, variable_value: CompletionRuleVariableVariableValueField, *, type: CompletionRuleVariableTypeField = CompletionRuleVariableTypeField.VARIABLE, variable_type: CompletionRuleVariableVariableTypeField = CompletionRuleVariableVariableTypeField.TASK_COMPLETION_RULE, **kwargs):
        """
