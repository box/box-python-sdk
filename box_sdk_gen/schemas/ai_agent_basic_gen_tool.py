...
from box_sdk_gen.schemas.ai_agent_long_text_tool_text_gen import AiAgentLongTextToolTextGenEmbeddingsField

from box_sdk_gen.schemas.ai_agent_long_text_tool_text_gen import AiAgentLongTextToolTextGen

from box_sdk_gen.box.errors import BoxSDKError

class AiAgentBasicGenTool(AiAgentLongTextToolTextGen):
    def __init__(self, *, content_template: Optional[str] = None, embeddings: Optional[AiAgentLongTextToolTextGenEmbeddingsField] = None, system_message: Optional[str] = None, prompt_template: Optional[str] = None, model: Optional[str] = None, num_tokens_for_completion: Optional[int] = None, llm_endpoint_params: Optional[AiLlmEndpointParams] = None, **kwargs):
        """
...
Inputs for `{current_date}` and `{content}` are optional, depending on the use., defaults to None
        ...
        """
        super().__init__(embeddings=embeddings, system_message=system_message, prompt_template=prompt_template, model=model, num_tokens_for_completion=num_tokens_for_completion, llm_endpoint_params=llm_endpoint_params, **kwargs)
