...
class TrashFolderPathCollectionEntriesField(BaseObject):
    ...
    def __init__(self, *, type: Optional[TrashFolderPathCollectionEntriesTypeField] = None, id: Optional[str] = None, sequence_id: Optional[str] = None, etag: Optional[str] = None, name: Optional[str] = None, **kwargs):
        """
...
class TrashFolderPathCollectionField(BaseObject):
    def __init__(self, total_count: int, entries: List[TrashFolderPathCollectionEntriesField], **kwargs):
        """
