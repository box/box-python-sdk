...
class TimelineSkillCardSkillField(BaseObject):
    ...
    def __init__(self, id: str, *, type: TimelineSkillCardSkillTypeField = TimelineSkillCardSkillTypeField.SERVICE, **kwargs):
        """
...
class TimelineSkillCardInvocationField(BaseObject):
    ...
    def __init__(self, id: str, *, type: TimelineSkillCardInvocationTypeField = TimelineSkillCardInvocationTypeField.SKILL_INVOCATION, **kwargs):
        """
...
class TimelineSkillCardEntriesField(BaseObject):
    def __init__(self, *, text: Optional[str] = None, appears: Optional[List[TimelineSkillCardEntriesAppearsField]] = None, image_url: Optional[str] = None, **kwargs):
        """
