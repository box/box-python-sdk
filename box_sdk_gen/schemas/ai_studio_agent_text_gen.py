...
class AiStudioAgentTextGen(BaseObject):
    ...
    def __init__(self, access_state: str, description: str, *, type: AiStudioAgentTextGenTypeField = AiStudioAgentTextGenTypeField.AI_AGENT_TEXT_GEN, custom_instructions: Optional[str] = None, basic_gen: Optional[AiStudioAgentBasicGenTool] = None, **kwargs):
        """
