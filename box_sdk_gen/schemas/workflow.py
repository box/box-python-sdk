...
class WorkflowFlowsTriggerScopeObjectField(BaseObject):
    ...
    def __init__(self, *, type: Optional[WorkflowFlowsTriggerScopeObjectTypeField] = None, id: Optional[str] = None, **kwargs):
        """
...
class WorkflowFlowsTriggerScopeField(BaseObject):
    ...
    def __init__(self, *, type: Optional[WorkflowFlowsTriggerScopeTypeField] = None, ref: Optional[str] = None, object: Optional[WorkflowFlowsTriggerScopeObjectField] = None, **kwargs):
        """
...
class WorkflowFlowsTriggerField(BaseObject):
    ...
    def __init__(self, *, type: Optional[WorkflowFlowsTriggerTypeField] = None, trigger_type: Optional[WorkflowFlowsTriggerTriggerTypeField] = None, scope: Optional[List[WorkflowFlowsTriggerScopeField]] = None, **kwargs):
        """
...
class WorkflowFlowsOutcomesIfRejectedField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[WorkflowFlowsOutcomesIfRejectedTypeField] = None, name: Optional[str] = None, action_type: Optional[WorkflowFlowsOutcomesIfRejectedActionTypeField] = None, **kwargs):
        """
...
class WorkflowFlowsOutcomesField(BaseObject):
    _discriminator = 'type', {'outcome'}
    def __init__(self, *, id: Optional[str] = None, type: Optional[WorkflowFlowsOutcomesTypeField] = None, name: Optional[str] = None, action_type: Optional[WorkflowFlowsOutcomesActionTypeField] = None, if_rejected: Optional[List[WorkflowFlowsOutcomesIfRejectedField]] = None, **kwargs):
        """
        :param id: The identifier of the outcome, defaults to None
        :type id: Optional[str], optional
        :param type: The outcomes resource type, defaults to None
...
class WorkflowFlowsField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[WorkflowFlowsTypeField] = None, trigger: Optional[WorkflowFlowsTriggerField] = None, outcomes: Optional[List[WorkflowFlowsOutcomesField]] = None, created_at: Optional[DateTime] = None, created_by: Optional[UserBase] = None, **kwargs):
        """
