...
class RetentionPolicyMini(RetentionPolicyBase):
    def __init__(self, id: str, *, policy_name: Optional[str] = None, retention_length: Optional[str] = None, disposition_action: Optional[RetentionPolicyMiniDispositionActionField] = None, type: RetentionPolicyBaseTypeField = RetentionPolicyBaseTypeField.RETENTION_POLICY, **kwargs):
        """
