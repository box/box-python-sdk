...
class RecentItem(BaseObject):
    def __init__(self, *, type: Optional[str] = None, item: Optional[Union[FileFull, FolderFull, WebLink]] = None, interaction_type: Optional[RecentItemInteractionTypeField] = None, interacted_at: Optional[DateTime] = None, interaction_shared_link: Optional[str] = None, **kwargs):
        """
