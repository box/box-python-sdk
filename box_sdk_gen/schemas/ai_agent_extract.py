...
class AiAgentExtract(BaseObject):
    ...
    def __init__(self, *, type: AiAgentExtractTypeField = AiAgentExtractTypeField.AI_AGENT_EXTRACT, long_text: Optional[AiAgentLongTextTool] = None, basic_text: Optional[AiAgentBasicTextTool] = None, basic_image: Optional[AiAgentBasicTextTool] = None, **kwargs):
        """
