...
class StatusSkillCardStatusField(BaseObject):
    def __init__(self, code: StatusSkillCardStatusCodeField, *, message: Optional[str] = None, **kwargs):
        """
...
class StatusSkillCardSkillField(BaseObject):
    ...
    def __init__(self, id: str, *, type: StatusSkillCardSkillTypeField = StatusSkillCardSkillTypeField.SERVICE, **kwargs):
        """
...
class StatusSkillCardInvocationField(BaseObject):
    ...
    def __init__(self, id: str, *, type: StatusSkillCardInvocationTypeField = StatusSkillCardInvocationTypeField.SKILL_INVOCATION, **kwargs):
        """
...
class StatusSkillCard(BaseObject):
    ...
    def __init__(self, status: StatusSkillCardStatusField, skill: StatusSkillCardSkillField, invocation: StatusSkillCardInvocationField, *, created_at: Optional[DateTime] = None, type: StatusSkillCardTypeField = StatusSkillCardTypeField.SKILL_CARD, skill_card_type: StatusSkillCardSkillCardTypeField = StatusSkillCardSkillCardTypeField.STATUS, skill_card_title: Optional[StatusSkillCardSkillCardTitleField] = None, **kwargs):
        """
