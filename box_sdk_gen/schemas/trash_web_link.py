...
class TrashWebLinkPathCollectionEntriesField(BaseObject):
    ...
    def __init__(self, *, type: Optional[TrashWebLinkPathCollectionEntriesTypeField] = None, id: Optional[str] = None, sequence_id: Optional[str] = None, etag: Optional[str] = None, name: Optional[str] = None, **kwargs):
        """
...
class TrashWebLinkPathCollectionField(BaseObject):
    def __init__(self, total_count: int, entries: List[TrashWebLinkPathCollectionEntriesField], **kwargs):
        """
