...
class FolderLock(BaseObject):
    def __init__(self, *, folder: Optional[FolderMini] = None, id: Optional[str] = None, type: Optional[str] = None, created_by: Optional[UserBase] = None, created_at: Optional[DateTime] = None, locked_operations: Optional[FolderLockLockedOperationsField] = None, lock_type: Optional[str] = None, **kwargs):
        """
