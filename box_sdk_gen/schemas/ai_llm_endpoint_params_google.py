...
class AiLlmEndpointParamsGoogle(BaseObject):
    ...
    def __init__(self, *, type: AiLlmEndpointParamsGoogleTypeField = AiLlmEndpointParamsGoogleTypeField.GOOGLE_PARAMS, temperature: Optional[float] = None, top_p: Optional[float] = None, top_k: Optional[float] = None, **kwargs):
        """
