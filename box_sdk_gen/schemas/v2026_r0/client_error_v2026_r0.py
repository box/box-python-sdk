...
class ClientErrorV2026R0TypeField(str, Enum):
    ERROR = 'error'


class ClientErrorV2026R0CodeField(str, Enum):
    CREATED = 'created'
    ACCEPTED = 'accepted'
...
class ClientErrorV2026R0(BaseObject):
    _discriminator = 'type', {'error'}

    def __init__(
        self,
        *,
        type: Optional[ClientErrorV2026R0TypeField] = None,
        status: Optional[int] = None,
        code: Optional[ClientErrorV2026R0CodeField] = None,
        ...
        **kwargs
        ...
        """
                ...
                :type type: Optional[ClientErrorV2026R0TypeField], optional
                ...
                :type code: Optional[ClientErrorV2026R0CodeField], optional
