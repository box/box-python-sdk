...
from box_sdk_gen.schemas.shield_information_barrier_segment_restriction_base import ShieldInformationBarrierSegmentRestrictionBaseTypeField

from box_sdk_gen.schemas.shield_information_barrier_segment_restriction_base import ShieldInformationBarrierSegmentRestrictionBase

from box_sdk_gen.box.errors import BoxSDKError

class ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentTypeField(str, Enum):
...
class ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentTypeField] = None, **kwargs):
        """
...
class ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentTypeField(str, Enum):
    SHIELD_INFORMATION_BARRIER_SEGMENT = 'shield_information_barrier_segment'

class ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentField(BaseObject):
    _discriminator = 'type', {'shield_information_barrier_segment'}
    def __init__(self, *, id: Optional[str] = None, type: Optional[ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentTypeField] = None, **kwargs):
        """
        :param id: The ID reference of the
