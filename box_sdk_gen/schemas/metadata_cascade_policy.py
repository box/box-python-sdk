...
class MetadataCascadePolicyOwnerEnterpriseField(BaseObject):
    ...
    def __init__(self, *, type: Optional[MetadataCascadePolicyOwnerEnterpriseTypeField] = None, id: Optional[str] = None, **kwargs):
        """
...
class MetadataCascadePolicyParentField(BaseObject):
    ...
    def __init__(self, *, type: Optional[MetadataCascadePolicyParentTypeField] = None, id: Optional[str] = None, **kwargs):
        """
