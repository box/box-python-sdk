...
class FileVersion(FileVersionMini):
    def __init__(self, id: str, *, name: Optional[str] = None, size: Optional[int] = None, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, modified_by: Optional[UserMini] = None, trashed_at: Optional[DateTime] = None, trashed_by: Optional[UserMini] = None, restored_at: Optional[DateTime] = None, restored_by: Optional[UserMini] = None, purged_at: Optional[DateTime] = None, uploader_display_name: Optional[str] = None, sha_1: Optional[str] = None, type: FileVersionBaseTypeField = FileVersionBaseTypeField.FILE_VERSION, **kwargs):
        """
