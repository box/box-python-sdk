...
perform changes on the file if (no) changes have happened., defaults to None
        ...
        """
        super().__init__(id=id, sequence_id=sequence_id, name=name, sha_1=sha_1, file_version=file_version, etag=etag, type=type, **kwargs)
