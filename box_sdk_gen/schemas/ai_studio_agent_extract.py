...
class AiStudioAgentExtract(BaseObject):
    ...
    def __init__(self, access_state: str, description: str, *, type: AiStudioAgentExtractTypeField = AiStudioAgentExtractTypeField.AI_AGENT_EXTRACT, custom_instructions: Optional[str] = None, long_text: Optional[AiStudioAgentLongTextTool] = None, basic_text: Optional[AiStudioAgentBasicTextTool] = None, **kwargs):
        """
