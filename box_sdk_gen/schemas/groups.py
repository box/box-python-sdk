...
class GroupsOrderField(BaseObject):
    def __init__(self, *, by: Optional[str] = None, direction: Optional[GroupsOrderDirectionField] = None, **kwargs):
        """
...
class Groups(BaseObject):
    def __init__(self, *, total_count: Optional[int] = None, limit: Optional[int] = None, offset: Optional[int] = None, order: Optional[List[GroupsOrderField]] = None, entries: Optional[List[GroupFull]] = None, **kwargs):
        """
