...
class LegalHoldPolicy(LegalHoldPolicyMini):
    def __init__(self, id: str, *, policy_name: Optional[str] = None, description: Optional[str] = None, status: Optional[LegalHoldPolicyStatusField] = None, assignment_counts: Optional[LegalHoldPolicyAssignmentCountsField] = None, created_by: Optional[UserMini] = None, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, deleted_at: Optional[DateTime] = None, filter_started_at: Optional[DateTime] = None, filter_ended_at: Optional[DateTime] = None, release_notes: Optional[str] = None, type: LegalHoldPolicyMiniTypeField = LegalHoldPolicyMiniTypeField.LEGAL_HOLD_POLICY, **kwargs):
        """
