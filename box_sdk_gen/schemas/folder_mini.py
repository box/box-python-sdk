...
class FolderMini(FolderBase):
    def __init__(self, id: str, *, sequence_id: Optional[str] = None, name: Optional[str] = None, etag: Optional[str] = None, type: FolderBaseTypeField = FolderBaseTypeField.FOLDER, **kwargs):
        """
