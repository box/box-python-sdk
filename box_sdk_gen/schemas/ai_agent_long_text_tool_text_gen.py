...
from box_sdk_gen.schemas.ai_agent_basic_text_tool_text_gen import AiAgentBasicTextToolTextGen

from box_sdk_gen.box.errors import BoxSDKError

class AiAgentLongTextToolTextGenEmbeddingsStrategyField(BaseObject):
    def __init__(self, *, id: Optional[str] = None, num_tokens_per_chunk: Optional[int] = None, **kwargs):
        """
...
class AiAgentLongTextToolTextGenEmbeddingsField(BaseObject):
    def __init__(self, *, model: Optional[str] = None, strategy: Optional[AiAgentLongTextToolTextGenEmbeddingsStrategyField] = None, **kwargs):
        """
...
class AiAgentLongTextToolTextGen(AiAgentBasicTextToolTextGen):
    def __init__(self, *, embeddings: Optional[AiAgentLongTextToolTextGenEmbeddingsField] = None, system_message: Optional[str] = None, prompt_template: Optional[str] = None, model: Optional[str] = None, num_tokens_for_completion: Optional[int] = None, llm_endpoint_params: Optional[AiLlmEndpointParams] = None, **kwargs):
        """
...
Inputs for `{current_date}` and `{content}` are optional, depending on the use., defaults to None
        ...
        """
        super().__init__(system_message=system_message, prompt_template=prompt_template, model=model, num_tokens_for_completion=num_tokens_for_completion, llm_endpoint_params=llm_endpoint_params, **kwargs)
