...
class AiAgentInfoModelsField(BaseObject):
    def __init__(self, *, name: Optional[str] = None, provider: Optional[str] = None, supported_purpose: Optional[str] = None, **kwargs):
        """
...
class AiAgentInfo(BaseObject):
    def __init__(self, *, models: Optional[List[AiAgentInfoModelsField]] = None, processor: Optional[str] = None, **kwargs):
        """
