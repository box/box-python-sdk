...
class TranscriptSkillCardSkillField(BaseObject):
    ...
    def __init__(self, id: str, *, type: TranscriptSkillCardSkillTypeField = TranscriptSkillCardSkillTypeField.SERVICE, **kwargs):
        """
...
class TranscriptSkillCardInvocationField(BaseObject):
    ...
    def __init__(self, id: str, *, type: TranscriptSkillCardInvocationTypeField = TranscriptSkillCardInvocationTypeField.SKILL_INVOCATION, **kwargs):
        """
...
class TranscriptSkillCardEntriesField(BaseObject):
    def __init__(self, *, text: Optional[str] = None, appears: Optional[List[TranscriptSkillCardEntriesAppearsField]] = None, **kwargs):
        """
