...
from box_sdk_gen.schemas.retention_policy_mini import RetentionPolicyMiniDispositionActionField
...
once the retention policy has expired., defaults to None
        ...
        """
        super().__init__(id=id, policy_name=policy_name, retention_length=retention_length, disposition_action=disposition_action, type=type, **kwargs)
