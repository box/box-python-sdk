...
class CollaboratorVariableVariableValueField(BaseObject):
    ...
    def __init__(self, id: str, *, type: CollaboratorVariableVariableValueTypeField = CollaboratorVariableVariableValueTypeField.USER, **kwargs):
        """
        :param id: User's ID.
        :type id: str
...
class CollaboratorVariable(BaseObject):
    ...
    def __init__(self, variable_value: List[CollaboratorVariableVariableValueField], *, type: CollaboratorVariableTypeField = CollaboratorVariableTypeField.VARIABLE, variable_type: CollaboratorVariableVariableTypeField = CollaboratorVariableVariableTypeField.USER_LIST, **kwargs):
        """
