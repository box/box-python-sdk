...
class InviteInvitedToField(BaseObject):
    ...
    def __init__(self, *, id: Optional[str] = None, type: Optional[InviteInvitedToTypeField] = None, name: Optional[str] = None, **kwargs):
        """
...
class Invite(BaseObject):
    ...
    def __init__(self, id: str, *, type: InviteTypeField = InviteTypeField.INVITE, invited_to: Optional[InviteInvitedToField] = None, actionable_by: Optional[UserMini] = None, invited_by: Optional[UserMini] = None, status: Optional[str] = None, created_at: Optional[DateTime] = None, modified_at: Optional[DateTime] = None, **kwargs):
        """
