...
Example: "12345"
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/folders/', to_string(folder_id), '/metadata']), method='GET', headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, Metadatas)
    def get_folder_metadata_by_id(self, folder_id: str, scope: GetFolderMetadataByIdScope, template_key: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> MetadataFull:
        """
...
Example: "properties"
    ...
    def create_folder_metadata_by_id(self, folder_id: str, scope: CreateFolderMetadataByIdScope, template_key: str, request_body: Dict, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> MetadataFull:
        """
...
Example: "properties"
        ...
        return deserialize(response.data, MetadataFull)
    def update_folder_metadata_by_id(self, folder_id: str, scope: UpdateFolderMetadataByIdScope, template_key: str, request_body: List[UpdateFolderMetadataByIdRequestBody], *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> MetadataFull:
        """
...
Example: "properties"
        ...
        return deserialize(response.data, MetadataFull)
    def delete_folder_metadata_by_id(self, folder_id: str, scope: DeleteFolderMetadataByIdScope, template_key: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> None:
        """
