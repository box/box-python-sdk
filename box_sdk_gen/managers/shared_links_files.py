...
class AddShareLinkToFileSharedLink(BaseObject):
    def __init__(self, *, access: Optional[AddShareLinkToFileSharedLinkAccessField] = None, password: Optional[str] = None, vanity_name: Optional[str] = None, unshared_at: Optional[DateTime] = None, permissions: Optional[AddShareLinkToFileSharedLinkPermissionsField] = None, **kwargs):
        """
...
class UpdateSharedLinkOnFileSharedLink(BaseObject):
    def __init__(self, *, access: Optional[UpdateSharedLinkOnFileSharedLinkAccessField] = None, password: Optional[str] = None, vanity_name: Optional[str] = None, unshared_at: Optional[DateTime] = None, permissions: Optional[UpdateSharedLinkOnFileSharedLinkPermissionsField] = None, **kwargs):
        """
        :param access: The level of access for the shared link. This can be
restricted to anyone with the link (`open`), only people
within the company (`company`) and only those who
...
class SharedLinksFilesManager:
    ...
    def find_file_for_shared_link(self, boxapi: str, *, fields: Optional[List[str]] = None, if_none_match: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FileFull:
        """
...
changed since., defaults to None
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/shared_items']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, FileFull)
    def get_shared_link_for_file(self, file_id: str, fields: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FileFull:
        """
...
to be returned for this item.
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/files/', to_string(file_id), '#get_shared_link']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, FileFull)
    def add_share_link_to_file(self, file_id: str, fields: str, *, shared_link: Optional[AddShareLinkToFileSharedLink] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FileFull:
        """
...
links., defaults to None
        ...
        return deserialize(response.data, FileFull)
    def update_shared_link_on_file(self, file_id: str, fields: str, *, shared_link: Optional[UpdateSharedLinkOnFileSharedLink] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FileFull:
        """
...
to be returned for this item.
        ...
        return deserialize(response.data, FileFull)
    def remove_shared_link_from_file(self, file_id: str, fields: str, *, shared_link: Union[Optional[RemoveSharedLinkFromFileSharedLink], NullValue] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FileFull:
        """
