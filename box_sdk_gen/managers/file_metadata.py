...
Example: "12345"
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/files/', to_string(file_id), '/metadata']), method='GET', headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, Metadatas)
    def get_file_metadata_by_id(self, file_id: str, scope: GetFileMetadataByIdScope, template_key: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> MetadataFull:
        """
...
Example: "properties"
    ...
    def create_file_metadata_by_id(self, file_id: str, scope: CreateFileMetadataByIdScope, template_key: str, request_body: Dict, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> MetadataFull:
        """
...
Example: "properties"
        ...
        return deserialize(response.data, MetadataFull)
    def update_file_metadata_by_id(self, file_id: str, scope: UpdateFileMetadataByIdScope, template_key: str, request_body: List[UpdateFileMetadataByIdRequestBody], *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> MetadataFull:
        """
...
Example: "properties"
        ...
        return deserialize(response.data, MetadataFull)
    def delete_file_metadata_by_id(self, file_id: str, scope: DeleteFileMetadataByIdScope, template_key: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> None:
        """
