...
class UploadFileVersionAttributes(BaseObject):
    def __init__(self, name: str, *, content_modified_at: Optional[DateTime] = None, **kwargs):
        """
...
class UploadFileAttributes(BaseObject):
    def __init__(self, name: str, parent: UploadFileAttributesParentField, *, content_created_at: Optional[DateTime] = None, content_modified_at: Optional[DateTime] = None, **kwargs):
        """
...
class UploadWithPreflightCheckAttributes(BaseObject):
    def __init__(self, name: str, parent: UploadWithPreflightCheckAttributesParentField, size: int, *, content_created_at: Optional[DateTime] = None, content_modified_at: Optional[DateTime] = None, **kwargs):
        """
        :param name: The name of the file.
...
class UploadsManager:
    ...
    def upload_file_version(self, file_id: str, attributes: UploadFileVersionAttributes, file: ByteStream, *, file_file_name: Optional[str] = None, file_content_type: Optional[str] = None, fields: Optional[List[str]] = None, if_match: Optional[str] = None, content_md_5: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> Files:
        """
...
has changed since., defaults to None
        ...
        if extra_headers is None:
            extra_headers = {}
        request_body: Dict = {'attributes': attributes, 'file': file, 'file_file_name': file_file_name, 'file_content_type': file_content_type}
    ...
    def upload_file(self, attributes: UploadFileAttributes, file: ByteStream, *, file_file_name: Optional[str] = None, file_content_type: Optional[str] = None, fields: Optional[List[str]] = None, content_md_5: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> Files:
        """
...
to the fields requested., defaults to None
        ...
        return deserialize(response.data, Files)
    def upload_with_preflight_check(self, attributes: UploadWithPreflightCheckAttributes, file: ByteStream, *, file_file_name: Optional[str] = None, file_content_type: Optional[str] = None, fields: Optional[List[str]] = None, content_md_5: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> Files:
        """
...
to the fields requested., defaults to None
        ...
        query_params_map: Dict[str, str] = prepare_params({'fields': to_string(fields)})
        headers_map: Dict[str, str] = prepare_params({'content-md5': to_string(content_md_5), **extra_headers})
        preflight_upload_url: UploadUrl = self.preflight_file_upload_check(name=attributes.name, size=attributes.size, parent=PreflightFileUploadCheckParent(id=attributes.parent.id), extra_headers=extra_headers)
        if preflight_upload_url.upload_url == None or not 'http' in preflight_upload_url.upload_url:
