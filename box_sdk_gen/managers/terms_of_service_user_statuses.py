...
from box_sdk_gen.schemas.terms_of_service_user_statuses import TermsOfServiceUserStatuses
...
class CreateTermsOfServiceStatusForUserTos(BaseObject):
    ...
    def __init__(self, id: str, *, type: CreateTermsOfServiceStatusForUserTosTypeField = CreateTermsOfServiceStatusForUserTosTypeField.TERMS_OF_SERVICE, **kwargs):
        """
...
class CreateTermsOfServiceStatusForUserUser(BaseObject):
    ...
    def __init__(self, id: str, *, type: CreateTermsOfServiceStatusForUserUserTypeField = CreateTermsOfServiceStatusForUserUserTypeField.USER, **kwargs):
        """
...
class TermsOfServiceUserStatusesManager:
    ...
    def get_terms_of_service_user_statuses(self, tos_id: str, *, user_id: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> TermsOfServiceUserStatuses:
        """
    ...
    def create_terms_of_service_status_for_user(self, tos: CreateTermsOfServiceStatusForUserTos, user: CreateTermsOfServiceStatusForUserUser, is_accepted: bool, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> TermsOfServiceUserStatus:
        """
    ...
    def update_terms_of_service_status_for_user_by_id(self, terms_of_service_user_status_id: str, is_accepted: bool, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> TermsOfServiceUserStatus:
        """
