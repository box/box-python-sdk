...
class DownloadsManager:
    ...
    def get_download_file_url(self, file_id: str, *, version: Optional[str] = None, access_token: Optional[str] = None, range: Optional[str] = None, boxapi: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> str:
        """
...
or folders nested within the item., defaults to None
    ...
    def download_file(self, file_id: str, *, version: Optional[str] = None, access_token: Optional[str] = None, range: Optional[str] = None, boxapi: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> Optional[ByteStream]:
        """
        Returns the contents of a file in binary format.
        :param file_id: The unique identifier that represents a file.
...
or folders nested within the item., defaults to None
        ...
        query_params_map: Dict[str, str] = prepare_params({'version': to_string(version), 'access_token': to_string(access_token)})
        headers_map: Dict[str, str] = prepare_params({'range': to_string(range), 'boxapi': to_string(boxapi), **extra_headers})
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/files/', to_string(file_id), '/content']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.BINARY, auth=self.auth, network_session=self.network_session))
        if to_string(response.status) == '202':
            return None
        return response.content
    def download_file_to_output_stream(self, file_id: str, output_stream: OutputStream, *, version: Optional[str] = None, access_token: Optional[str] = None, range: Optional[str] = None, boxapi: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> None:
        """
        :param file_id: The unique identifier that represents a file.
...
or folders nested within the item., defaults to None
        ...
        if extra_headers is None:
            extra_headers = {}
        download_stream: ByteStream = self.download_file(file_id, version=version, access_token=access_token, range=range, boxapi=boxapi, extra_headers=extra_headers)
