...
class UpdateFileByIdSharedLink(BaseObject):
    def __init__(self, *, access: Optional[UpdateFileByIdSharedLinkAccessField] = None, password: Optional[str] = None, vanity_name: Optional[str] = None, unshared_at: Optional[DateTime] = None, permissions: Optional[UpdateFileByIdSharedLinkPermissionsField] = None, **kwargs):
        """
...
class UpdateFileByIdLock(BaseObject):
    def __init__(self, *, access: Optional[UpdateFileByIdLockAccessField] = None, expires_at: Optional[DateTime] = None, is_download_prevented: Optional[bool] = None, **kwargs):
        """
...
class UpdateFileByIdPermissions(BaseObject):
    def __init__(self, *, can_download: Optional[UpdateFileByIdPermissionsCanDownloadField] = None, **kwargs):
        """
...
class FilesManager:
    ...
    def get_file_by_id(self, file_id: str, *, fields: Optional[List[str]] = None, if_none_match: Optional[str] = None, boxapi: Optional[str] = None, x_rep_hints: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FileFull:
        """
...
has changed since., defaults to None
        ...
        if extra_headers is None:
            extra_headers = {}
        request_body: Dict = {'name': name, 'description': description, 'parent': parent, 'shared_link': shared_link, 'lock': lock, 'disposition_at': disposition_at, 'permissions': permissions, 'collections': collections, 'tags': tags}
        query_params_map: Dict[str, str] = prepare_params({'fields': to_string(fields)})
...
has changed since., defaults to None
        ...
        if extra_headers is None:
            extra_headers = {}
        headers_map: Dict[str, str] = prepare_params({'if-match': to_string(if_match), **extra_headers})
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/files/', to_string(file_id)]), method='DELETE', headers=headers_map, response_format=ResponseFormat.NO_CONTENT, auth=self.auth, network_session=self.network_session))
        return None
    def copy_file(self, file_id: str, parent: CopyFileParent, *, name: Optional[str] = None, version: Optional[str] = None, fields: Optional[List[str]] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FileFull:
        r"""
...
to the fields requested., defaults to None
        ...
        return deserialize(response.data, FileFull)
    def get_file_thumbnail_url(self, file_id: str, extension: GetFileThumbnailUrlExtension, *, min_height: Optional[int] = None, min_width: Optional[int] = None, max_height: Optional[int] = None, max_width: Optional[int] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> str:
        """
...
Example: "png"
    ...
    def get_file_thumbnail_by_id(self, file_id: str, extension: GetFileThumbnailByIdExtension, *, min_height: Optional[int] = None, min_width: Optional[int] = None, max_height: Optional[int] = None, max_width: Optional[int] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> Optional[ByteStream]:
        """
        Retrieves a thumbnail, or smaller image representation, of a file.
...
Example: "png"
        ...
        query_params_map: Dict[str, str] = prepare_params({'min_height': to_string(min_height), 'min_width': to_string(min_width), 'max_height': to_string(max_height), 'max_width': to_string(max_width)})
        headers_map: Dict[str, str] = prepare_params({**extra_headers})
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/files/', to_string(file_id), '/thumbnail.', to_string(extension)]), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.BINARY, auth=self.auth, network_session=self.network_session))
