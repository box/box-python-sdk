...
class AddClassificationRequestBodyDataStaticConfigField(BaseObject):
    def __init__(self, *, classification: Optional[AddClassificationRequestBodyDataStaticConfigClassificationField] = None, **kwargs):
        """
...
class AddClassificationRequestBody(BaseObject):
    ...
    def __init__(self, data: AddClassificationRequestBodyDataField, *, op: AddClassificationRequestBodyOpField = AddClassificationRequestBodyOpField.ADDENUMOPTION, field_key: AddClassificationRequestBodyFieldKeyField = AddClassificationRequestBodyFieldKeyField.BOX__SECURITY__CLASSIFICATION__KEY, **kwargs):
        """
...
class UpdateClassificationRequestBodyDataStaticConfigField(BaseObject):
    def __init__(self, *, classification: Optional[UpdateClassificationRequestBodyDataStaticConfigClassificationField] = None, **kwargs):
        """
        :param classification: Additional details for the classification., defaults to None
...
class UpdateClassificationRequestBody(BaseObject):
    ...
    def __init__(self, enum_option_key: str, data: UpdateClassificationRequestBodyDataField, *, op: UpdateClassificationRequestBodyOpField = UpdateClassificationRequestBodyOpField.EDITENUMOPTION, field_key: UpdateClassificationRequestBodyFieldKeyField = UpdateClassificationRequestBodyFieldKeyField.BOX__SECURITY__CLASSIFICATION__KEY, **kwargs):
        """
...
class CreateClassificationTemplateFieldsOptionsStaticConfigClassificationField(BaseObject):
    _fields_to_json_mapping: Dict[str, str] = {'classification_definition': 'classificationDefinition', 'color_id': 'colorID', **BaseObject._fields_to_json_mapping}
    _json_to_fields_mapping: Dict[str, str] = {'classificationDefinition': 'classification_definition', 'colorID': 'color_id', **BaseObject._json_to_fields_mapping}
    def __init__(self, *, classification_definition: Optional[str] = None, color_id: Optional[int] = None, **kwargs):
        """
...
class CreateClassificationTemplateFieldsOptionsStaticConfigField(BaseObject):
    def __init__(self, *, classification: Optional[CreateClassificationTemplateFieldsOptionsStaticConfigClassificationField] = None, **kwargs):
        """
...
class ClassificationsManager:
    ...
    def get_classification_template(self, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> ClassificationTemplate:
        """
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/metadata_templates/enterprise/securityClassification-6VMVochwUWo/schema']), method='GET', headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, ClassificationTemplate)
    def add_classification(self, request_body: List[AddClassificationRequestBody], *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> ClassificationTemplate:
        """
        ...
        return deserialize(response.data, ClassificationTemplate)
    def update_classification(self, request_body: List[UpdateClassificationRequestBody], *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> ClassificationTemplate:
        """
...
copied., defaults to None
        ...
        if extra_headers is None:
            extra_headers = {}
        request_body: Dict = {'scope': scope, 'templateKey': template_key, 'displayName': display_name, 'hidden': hidden, 'copyInstanceOnItemCopy': copy_instance_on_item_copy, 'fields': fields}
        headers_map: Dict[str, str] = prepare_params({**extra_headers})
