...
from box_sdk_gen.schemas.integration_mapping_partner_item_teams_create_request import IntegrationMappingPartnerItemTeamsCreateRequest
...
from box_sdk_gen.schemas.integration_mapping_slack_create_request import IntegrationMappingSlackCreateRequest

from box_sdk_gen.schemas.integration_mapping_box_item_slack import IntegrationMappingBoxItemSlack

from box_sdk_gen.schemas.integration_mapping_slack_options import IntegrationMappingSlackOptions
...
from box_sdk_gen.schemas.integration_mapping_teams_create_request import IntegrationMappingTeamsCreateRequest
...
class IntegrationMappingsManager:
    ...
    def get_slack_integration_mapping(self, *, marker: Optional[str] = None, limit: Optional[int] = None, partner_item_type: Optional[GetSlackIntegrationMappingPartnerItemType] = None, partner_item_id: Optional[str] = None, box_item_id: Optional[str] = None, box_item_type: Optional[GetSlackIntegrationMappingBoxItemType] = None, is_manually_created: Optional[bool] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> IntegrationMappings:
        """
...
This requires `usemarker` to be set to `true`., defaults to None
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/integration_mappings/slack']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, IntegrationMappings)
    def create_slack_integration_mapping(self, partner_item: IntegrationMappingPartnerItemSlack, box_item: IntegrationMappingBoxItemSlack, *, options: Optional[IntegrationMappingSlackOptions] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> IntegrationMapping:
        """
        ...
        if extra_headers is None:
            extra_headers = {}
        request_body: Dict = {'partner_item': partner_item, 'box_item': box_item, 'options': options}
        headers_map: Dict[str, str] = prepare_params({**extra_headers})
    ...
    def update_slack_integration_mapping_by_id(self, integration_mapping_id: str, *, box_item: Optional[IntegrationMappingBoxItemSlack] = None, options: Optional[IntegrationMappingSlackOptions] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> IntegrationMapping:
        """
...
Example: "11235432"
        ...
        return deserialize(response.data, IntegrationMapping)
    def delete_slack_integration_mapping_by_id(self, integration_mapping_id: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> None:
        """
...
Example: "11235432"
        ...
        if extra_headers is None:
            extra_headers = {}
        headers_map: Dict[str, str] = prepare_params({**extra_headers})
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/integration_mappings/slack/', to_string(integration_mapping_id)]), method='DELETE', headers=headers_map, response_format=ResponseFormat.NO_CONTENT, auth=self.auth, network_session=self.network_session))
        return None
    def get_teams_integration_mapping(self, *, partner_item_type: Optional[GetTeamsIntegrationMappingPartnerItemType] = None, partner_item_id: Optional[str] = None, box_item_id: Optional[str] = None, box_item_type: Optional[GetTeamsIntegrationMappingBoxItemType] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> IntegrationMappingsTeams:
        ...
        if extra_headers is None:
            extra_headers = {}
        query_params_map: Dict[str, str] = prepare_params({'partner_item_type': to_string(partner_item_type), 'partner_item_id': to_string(partner_item_id), 'box_item_id': to_string(box_item_id), 'box_item_type': to_string(box_item_type)})
        headers_map: Dict[str, str] = prepare_params({**extra_headers})
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/integration_mappings/teams']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, IntegrationMappingsTeams)
    def create_teams_integration_mapping(self, partner_item: IntegrationMappingPartnerItemTeamsCreateRequest, box_item: FolderReference, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> IntegrationMappingTeams:
        """
    ...
    def update_teams_integration_mapping_by_id(self, integration_mapping_id: str, *, box_item: Optional[FolderReference] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> IntegrationMappingTeams:
        """
...
Example: "11235432"
        ...
        return deserialize(response.data, IntegrationMappingTeams)
    def delete_teams_integration_mapping_by_id(self, integration_mapping_id: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> None:
        """
...
Example: "11235432"
        ...
        if extra_headers is None:
            extra_headers = {}
        headers_map: Dict[str, str] = prepare_params({**extra_headers})
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/integration_mappings/teams/', to_string(integration_mapping_id)]), method='DELETE', headers=headers_map, response_format=ResponseFormat.NO_CONTENT, auth=self.auth, network_session=self.network_session))
        return None