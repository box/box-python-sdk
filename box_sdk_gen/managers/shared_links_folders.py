...
class AddShareLinkToFolderSharedLink(BaseObject):
    def __init__(self, *, access: Optional[AddShareLinkToFolderSharedLinkAccessField] = None, password: Optional[str] = None, vanity_name: Optional[str] = None, unshared_at: Optional[DateTime] = None, permissions: Optional[AddShareLinkToFolderSharedLinkPermissionsField] = None, **kwargs):
        """
...
class UpdateSharedLinkOnFolderSharedLink(BaseObject):
    def __init__(self, *, access: Optional[UpdateSharedLinkOnFolderSharedLinkAccessField] = None, password: Optional[str] = None, vanity_name: Optional[str] = None, unshared_at: Optional[DateTime] = None, permissions: Optional[UpdateSharedLinkOnFolderSharedLinkPermissionsField] = None, **kwargs):
        """
        :param access: The level of access for the shared link. This can be
restricted to anyone with the link (`open`), only people
within the company (`company`) and only those who
...
class SharedLinksFoldersManager:
    ...
    def find_folder_for_shared_link(self, boxapi: str, *, fields: Optional[List[str]] = None, if_none_match: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FolderFull:
        """
...
changed since., defaults to None
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/shared_items#folders']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, FolderFull)
    def get_shared_link_for_folder(self, folder_id: str, fields: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FolderFull:
        """
...
to be returned for this item.
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/folders/', to_string(folder_id), '#get_shared_link']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, FolderFull)
    def add_share_link_to_folder(self, folder_id: str, fields: str, *, shared_link: Optional[AddShareLinkToFolderSharedLink] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FolderFull:
        """
...
links., defaults to None
        ...
        return deserialize(response.data, FolderFull)
    def update_shared_link_on_folder(self, folder_id: str, fields: str, *, shared_link: Optional[UpdateSharedLinkOnFolderSharedLink] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FolderFull:
        """
...
to be returned for this item.
        ...
        return deserialize(response.data, FolderFull)
    def remove_shared_link_from_folder(self, folder_id: str, fields: str, *, shared_link: Union[Optional[RemoveSharedLinkFromFolderSharedLink], NullValue] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FolderFull:
        """
