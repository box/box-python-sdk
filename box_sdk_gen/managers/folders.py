...
class UpdateFolderByIdSharedLink(BaseObject):
    def __init__(self, *, access: Optional[UpdateFolderByIdSharedLinkAccessField] = None, password: Optional[str] = None, vanity_name: Optional[str] = None, unshared_at: Optional[DateTime] = None, permissions: Optional[UpdateFolderByIdSharedLinkPermissionsField] = None, **kwargs):
        """
...
class UpdateFolderByIdFolderUploadEmail(BaseObject):
    def __init__(self, *, access: Optional[UpdateFolderByIdFolderUploadEmailAccessField] = None, **kwargs):
        """
...
class CreateFolderFolderUploadEmail(BaseObject):
    def __init__(self, *, access: Optional[CreateFolderFolderUploadEmailAccessField] = None, **kwargs):
        """
        :param access: When this parameter has been set, users can email files
to the email address that has been automatically
created for this folder.
...
has changed since., defaults to None
        ...
        headers_map: Dict[str, str] = prepare_params({'if-match': to_string(if_match), **extra_headers})
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/folders/', to_string(folder_id)]), method='DELETE', params=query_params_map, headers=headers_map, response_format=ResponseFormat.NO_CONTENT, auth=self.auth, network_session=self.network_session))
        return None
    def get_folder_items(self, folder_id: str, *, fields: Optional[List[str]] = None, usemarker: Optional[bool] = None, marker: Optional[str] = None, offset: Optional[int] = None, limit: Optional[int] = None, sort: Optional[GetFolderItemsSort] = None, direction: Optional[GetFolderItemsDirection] = None, boxapi: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> Items:
        """
...
or folders nested within the item., defaults to None
    ...
    def create_folder(self, name: str, parent: CreateFolderParent, *, folder_upload_email: Optional[CreateFolderFolderUploadEmail] = None, sync_state: Optional[CreateFolderSyncState] = None, fields: Optional[List[str]] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FolderFull:
        r"""
...
to the fields requested., defaults to None
        ...
        if extra_headers is None:
            extra_headers = {}
        request_body: Dict = {'name': name, 'parent': parent, 'folder_upload_email': folder_upload_email, 'sync_state': sync_state}
        query_params_map: Dict[str, str] = prepare_params({'fields': to_string(fields)})
        headers_map: Dict[str, str] = prepare_params({**extra_headers})
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/folders']), method='POST', params=query_params_map, headers=headers_map, data=serialize(request_body), content_type='application/json', response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, FolderFull)
    def copy_folder(self, folder_id: str, parent: CopyFolderParent, *, name: Optional[str] = None, fields: Optional[List[str]] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> FolderFull:
        r"""
