...
class AddShareLinkToWebLinkSharedLink(BaseObject):
    def __init__(self, *, access: Optional[AddShareLinkToWebLinkSharedLinkAccessField] = None, password: Optional[str] = None, vanity_name: Optional[str] = None, unshared_at: Optional[DateTime] = None, permissions: Optional[AddShareLinkToWebLinkSharedLinkPermissionsField] = None, **kwargs):
        """
...
class UpdateSharedLinkOnWebLinkSharedLink(BaseObject):
    def __init__(self, *, access: Optional[UpdateSharedLinkOnWebLinkSharedLinkAccessField] = None, password: Optional[str] = None, vanity_name: Optional[str] = None, unshared_at: Optional[DateTime] = None, permissions: Optional[UpdateSharedLinkOnWebLinkSharedLinkPermissionsField] = None, **kwargs):
        """
        :param access: The level of access for the shared link. This can be
restricted to anyone with the link (`open`), only people
within the company (`company`) and only those who
...
class SharedLinksWebLinksManager:
    ...
    def find_web_link_for_shared_link(self, boxapi: str, *, fields: Optional[List[str]] = None, if_none_match: Optional[str] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> WebLink:
        """
...
changed since., defaults to None
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/shared_items#web_links']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, WebLink)
    def get_shared_link_for_web_link(self, web_link_id: str, fields: str, *, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> WebLink:
        """
...
to be returned for this item.
        ...
        response: FetchResponse = self.network_session.network_client.fetch(FetchOptions(url=''.join([self.network_session.base_urls.base_url, '/2.0/web_links/', to_string(web_link_id), '#get_shared_link']), method='GET', params=query_params_map, headers=headers_map, response_format=ResponseFormat.JSON, auth=self.auth, network_session=self.network_session))
        return deserialize(response.data, WebLink)
    def add_share_link_to_web_link(self, web_link_id: str, fields: str, *, shared_link: Optional[AddShareLinkToWebLinkSharedLink] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> WebLink:
        """
...
links., defaults to None
        ...
        return deserialize(response.data, WebLink)
    def update_shared_link_on_web_link(self, web_link_id: str, fields: str, *, shared_link: Optional[UpdateSharedLinkOnWebLinkSharedLink] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> WebLink:
        """
...
to be returned for this item.
        ...
        return deserialize(response.data, WebLink)
    def remove_shared_link_from_web_link(self, web_link_id: str, fields: str, *, shared_link: Union[Optional[RemoveSharedLinkFromWebLinkSharedLink], NullValue] = None, extra_headers: Optional[Dict[str, Optional[str]]] = None) -> WebLink:
        """
