...
class DataSanitizer:
    def __init__(self):
        self._keys_to_sanitize = {'authorization': '', 'access_token': '', 'refresh_token': '', 'subject_token': '', 'token': '', 'client_id': '', 'client_secret': '', 'shared_link': '', 'download_url': '', 'jwt_private_key': '', 'jwt_private_key_passphrase': '', 'password': ''}
