...
class MultipartItem:
    def __init__(self, part_name: str, *, data: Optional[SerializedData] = None, file_stream: Optional[ByteStream] = None, file_name: Optional[str] = None, content_type: Optional[str] = None):
        """
...
class FetchOptions:
    def __init__(self, url: str, method: str, *, params: Optional[Dict[str, str]] = None, headers: Optional[Dict[str, str]] = None, data: Optional[SerializedData] = None, file_stream: Optional[ByteStream] = None, multipart_data: Optional[List[MultipartItem]] = None, content_type: str = 'application/json', response_format: ResponseFormat = ResponseFormat.JSON, auth: Optional[Authentication] = None, network_session: Optional[NetworkSession] = None, follow_redirects: Optional[bool] = True):
        """
