...
def testDevicePinners():
    ...
    device_pinners: DevicePinners = client.device_pinners.get_enterprise_device_pinners(enterprise_id)
    assert len(device_pinners.entries) >= 0
    device_pinners_in_desc_direction: DevicePinners = client.device_pinners.get_enterprise_device_pinners(enterprise_id, direction=GetEnterpriseDevicePinnersDirection.DESC)
