...
def testFolderLocks():
    ...
    folder_lock: FolderLock = client.folder_locks.create_folder_lock(CreateFolderLockFolder(id=folder.id, type='folder'), locked_operations=CreateFolderLockLockedOperations(move=True, delete=True))
