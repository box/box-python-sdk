...
from box_sdk_gen.managers.shield_information_barriers import UpdateShieldInformationBarrierStatusStatus
...
def testShieldInformationBarriers():
    ...
    barrier_from_api: ShieldInformationBarrier = client.shield_information_barriers.get_shield_information_barrier_by_id(barrier_id)
    ...
    with pytest.raises(Exception):
        client.shield_information_barriers.update_shield_information_barrier_status(barrier_id, UpdateShieldInformationBarrierStatusStatus.DISABLED)