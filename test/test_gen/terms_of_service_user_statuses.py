...
from box_sdk_gen.managers.terms_of_service_user_statuses import CreateTermsOfServiceStatusForUserTos

from box_sdk_gen.managers.terms_of_service_user_statuses import CreateTermsOfServiceStatusForUserUser
...
def testGetTermsOfServiceUserStatuses():
    ...
    created_tos_user_status: TermsOfServiceUserStatus = client.terms_of_service_user_statuses.create_terms_of_service_status_for_user(CreateTermsOfServiceStatusForUserTos(id=tos.id), CreateTermsOfServiceStatusForUserUser(id=user.id), False)
    ...
    updated_tos_user_status: TermsOfServiceUserStatus = client.terms_of_service_user_statuses.update_terms_of_service_status_for_user_by_id(created_tos_user_status.id, True)
    assert updated_tos_user_status.is_accepted == True
    list_tos_user_statuses: TermsOfServiceUserStatuses = client.terms_of_service_user_statuses.get_terms_of_service_user_statuses(tos.id, user_id=user.id)
