...
def testListFileAppItemAssocations():
    ...
    file_app_item_associations: AppItemAssociations = client.app_item_associations.get_file_app_item_associations(file_id)
    ...
    file: FileFull = client.files.get_file_by_id(file_id, fields=['is_associated_with_app_item'])
...
def testListFolderAppItemAssocations():
    ...
    folder_app_item_associations: AppItemAssociations = client.app_item_associations.get_folder_app_item_associations(folder_id)
    ...
    folder: FolderFull = client.folders.get_folder_by_id(folder_id, fields=['is_associated_with_app_item'])
