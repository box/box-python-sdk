...
def testCreateUpdateGetDeleteTask():
    ...
    task: Task = client.tasks.create_task(CreateTaskItem(type=CreateTaskItemTypeField.FILE, id=file.id), action=CreateTaskAction.REVIEW, message='test message', due_at=date_time, completion_rule=CreateTaskCompletionRule.ALL_ASSIGNEES)
    ...
    updated_task: Task = client.tasks.update_task_by_id(task.id, message='updated message')
