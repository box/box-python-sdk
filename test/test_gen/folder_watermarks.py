...
from box_sdk_gen.managers.folder_watermarks import UpdateFolderWatermarkWatermarkImprintField
...
def testCreateGetDeleteFolderWatermark():
    ...
    folder: FolderFull = client.folders.create_folder(folder_name, CreateFolderParent(id='0'))
    created_watermark: Watermark = client.folder_watermarks.update_folder_watermark(folder.id, UpdateFolderWatermarkWatermark(imprint=UpdateFolderWatermarkWatermarkImprintField.DEFAULT))
