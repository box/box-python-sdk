...
from box_sdk_gen.managers.folder_metadata import UpdateFolderMetadataByIdRequestBodyOpField
...
def testUpdatingFolderMetadata():
    ...
    created_metadata: MetadataFull = client.folder_metadata.create_folder_metadata_by_id(folder.id, CreateFolderMetadataByIdScope.ENTERPRISE, template_key, {'name': 'John', 'age': 23, 'birthDate': '2001-01-03T02:20:50.520Z', 'countryCode': 'US', 'sports': ['basketball', 'tennis']})
    updated_metadata: MetadataFull = client.folder_metadata.update_folder_metadata_by_id(folder.id, UpdateFolderMetadataByIdScope.ENTERPRISE, template_key, [UpdateFolderMetadataByIdRequestBody(op=UpdateFolderMetadataByIdRequestBodyOpField.REPLACE, path='/name', value='Jack'), UpdateFolderMetadataByIdRequestBody(op=UpdateFolderMetadataByIdRequestBodyOpField.REPLACE, path='/age', value=24), UpdateFolderMetadataByIdRequestBody(op=UpdateFolderMetadataByIdRequestBodyOpField.REPLACE, path='/birthDate', value='2000-01-03T02:20:50.520Z'), UpdateFolderMetadataByIdRequestBody(op=UpdateFolderMetadataByIdRequestBodyOpField.REPLACE, path='/countryCode', value='CA'), UpdateFolderMetadataByIdRequestBody(op=UpdateFolderMetadataByIdRequestBodyOpField.REPLACE, path='/sports', value=['football'])])
    ...
    assert to_string(updated_metadata.extra_data.get('birthDate')) == '2000-01-03T02:20:50.520Z'
    ...
    client.folder_metadata.delete_folder_metadata_by_id(folder.id, DeleteFolderMetadataByIdScope.ENTERPRISE, template_key)
    client.metadata_templates.delete_metadata_template(DeleteMetadataTemplateScope.ENTERPRISE, template_key)
...
def testGlobalFolderMetadata():
    ...
    created_metadata: MetadataFull = client.folder_metadata.create_folder_metadata_by_id(folder.id, CreateFolderMetadataByIdScope.GLOBAL, 'properties', {'abc': 'xyz'})
    ...
    received_metadata: MetadataFull = client.folder_metadata.get_folder_metadata_by_id(folder.id, GetFolderMetadataByIdScope.GLOBAL, 'properties')
    assert to_string(received_metadata.extra_data.get('abc')) == 'xyz'
    new_value: str = 'bar'
    client.folder_metadata.update_folder_metadata_by_id(folder.id, UpdateFolderMetadataByIdScope.GLOBAL, 'properties', [UpdateFolderMetadataByIdRequestBody(op=UpdateFolderMetadataByIdRequestBodyOpField.REPLACE, path='/abc', value=new_value)])
    received_updated_metadata: MetadataFull = client.folder_metadata.get_folder_metadata_by_id(folder.id, GetFolderMetadataByIdScope.GLOBAL, 'properties')
    assert to_string(received_updated_metadata.extra_data.get('abc')) == new_value
    client.folder_metadata.delete_folder_metadata_by_id(folder.id, DeleteFolderMetadataByIdScope.GLOBAL, 'properties')
    with pytest.raises(Exception):
        client.folder_metadata.get_folder_metadata_by_id(folder.id, GetFolderMetadataByIdScope.GLOBAL, 'properties')
    client.folders.delete_folder_by_id(folder.id)
...
def testEnterpriseFolderMetadata():
    ...
    assert to_string(created_metadata.extra_data.get('birthDate')) == '2001-01-03T02:20:50.520Z'
