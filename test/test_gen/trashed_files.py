...
def testTrashedFiles():
    ...
    files: Files = client.uploads.upload_file(UploadFileAttributes(name=file_name, parent=UploadFileAttributesParentField(id='0')), file_byte_stream)
    ...
    restored_file: TrashFileRestored = client.trashed_files.restore_file_from_trash(file.id)
