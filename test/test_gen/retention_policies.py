...
def testCreateUpdateGetDeleteRetentionPolicy():
    ...
    retention_policy_by_id: RetentionPolicy = client.retention_policies.get_retention_policy_by_id(retention_policy.id)
    ...
    updated_retention_policy: RetentionPolicy = client.retention_policies.update_retention_policy_by_id(retention_policy.id, policy_name=updated_retention_policy_name)
