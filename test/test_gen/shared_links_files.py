...
from box_sdk_gen.managers.shared_links_files import AddShareLinkToFileSharedLinkAccessField

from box_sdk_gen.schemas.file_full import FileFull

from box_sdk_gen.managers.shared_links_files import UpdateSharedLinkOnFileSharedLink

from box_sdk_gen.managers.shared_links_files import UpdateSharedLinkOnFileSharedLinkAccessField
...
def testSharedLinksFiles():
    uploaded_files: Files = client.uploads.upload_file(UploadFileAttributes(name=get_uuid(), parent=UploadFileAttributesParentField(id='0')), generate_byte_stream(10))
    ...
    file_from_api: FileFull = client.shared_links_files.get_shared_link_for_file(file_id, 'shared_link')
    ...
    file_from_shared_link_password: FileFull = user_client.shared_links_files.find_file_for_shared_link(''.join(['shared_link=', file_from_api.shared_link.url, '&shared_link_password=Secret123@']))
    ...
    updated_file: FileFull = client.shared_links_files.update_shared_link_on_file(file_id, 'shared_link', shared_link=UpdateSharedLinkOnFileSharedLink(access=UpdateSharedLinkOnFileSharedLinkAccessField.COLLABORATORS))
    ...
    file_from_api_after_remove: FileFull = client.shared_links_files.get_shared_link_for_file(file_id, 'shared_link')
