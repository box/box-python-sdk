...
def testDocgenBatchAndJobs():
    ...
    created_docgen_template: DocGenTemplateBaseV2025R0 = client.docgen_template.create_docgen_template_v2025_r0(FileReferenceV2025R0(id=uploaded_file.id))
    docgen_batch: DocGenBatchBaseV2025R0 = client.docgen.create_docgen_batch_v2025_r0(FileReferenceV2025R0(id=uploaded_file.id), 'api', CreateDocgenBatchV2025R0DestinationFolder(id=folder.id), 'pdf', [DocGenDocumentGenerationDataV2025R0(generated_file_name='test', user_input={'abc': 'xyz'})])
    assert not docgen_batch.id == ''
    assert to_string(docgen_batch.type) == 'docgen_batch'
    docgen_batch_jobs: DocGenJobsV2025R0 = client.docgen.get_docgen_batch_job_by_id_v2025_r0(docgen_batch.id)
    ...
    docgen_jobs: DocGenJobsFullV2025R0 = client.docgen.get_docgen_jobs_v2025_r0(limit=500)
    ...
    assert to_string(docgen_jobs.entries[0].template_file_version.type) == 'file_version'
    ...
    docgen_job: DocGenJobV2025R0 = client.docgen.get_docgen_job_by_id_v2025_r0(docgen_job_item_from_list.id)
