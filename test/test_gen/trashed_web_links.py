...
def testTrashedWebLinks():
    ...
    from_trash: TrashWebLink = client.trashed_web_links.get_trashed_web_link_by_id(weblink.id)
    ...
    restored_weblink: TrashWebLinkRestored = client.trashed_web_links.restore_weblink_from_trash(weblink.id)
