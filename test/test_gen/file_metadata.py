...
def testGlobalFileMetadata():
    ...
    created_metadata: MetadataFull = client.file_metadata.create_file_metadata_by_id(file.id, CreateFileMetadataByIdScope.GLOBAL, 'properties', {'abc': 'xyz'})
    ...
    received_metadata: MetadataFull = client.file_metadata.get_file_metadata_by_id(file.id, GetFileMetadataByIdScope.GLOBAL, 'properties')
    assert to_string(received_metadata.extra_data.get('abc')) == 'xyz'
    new_value: str = 'bar'
    client.file_metadata.update_file_metadata_by_id(file.id, UpdateFileMetadataByIdScope.GLOBAL, 'properties', [UpdateFileMetadataByIdRequestBody(op=UpdateFileMetadataByIdRequestBodyOpField.REPLACE, path='/abc', value=new_value)])
    received_updated_metadata: MetadataFull = client.file_metadata.get_file_metadata_by_id(file.id, GetFileMetadataByIdScope.GLOBAL, 'properties')
    assert to_string(received_updated_metadata.extra_data.get('abc')) == new_value
    client.file_metadata.delete_file_metadata_by_id(file.id, DeleteFileMetadataByIdScope.GLOBAL, 'properties')
