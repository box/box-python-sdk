...
from box_sdk_gen.managers.shared_links_folders import AddShareLinkToFolderSharedLinkAccessField

from box_sdk_gen.managers.shared_links_folders import UpdateSharedLinkOnFolderSharedLink

from box_sdk_gen.managers.shared_links_folders import UpdateSharedLinkOnFolderSharedLinkAccessField
...
def testSharedLinksFolders():
    ...
    folder_from_api: FolderFull = client.shared_links_folders.get_shared_link_for_folder(folder.id, 'shared_link')
    ...
    folder_from_shared_link_password: FolderFull = user_client.shared_links_folders.find_folder_for_shared_link(''.join(['shared_link=', folder_from_api.shared_link.url, '&shared_link_password=Secret123@']))
    ...
    updated_folder: FolderFull = client.shared_links_folders.update_shared_link_on_folder(folder.id, 'shared_link', shared_link=UpdateSharedLinkOnFolderSharedLink(access=UpdateSharedLinkOnFolderSharedLinkAccessField.COLLABORATORS))
    ...
    folder_from_api_after_remove: FolderFull = client.shared_links_folders.get_shared_link_for_folder(folder.id, 'shared_link')
