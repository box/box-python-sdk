...
def testEmailAliases():
    ...
    new_alias: EmailAlias = client.email_aliases.create_user_email_alias(new_user.id, new_alias_email)
    updated_aliases: EmailAliases = client.email_aliases.get_user_email_aliases(new_user.id)
    ...
    final_aliases: EmailAliases = client.email_aliases.get_user_email_aliases(new_user.id)
