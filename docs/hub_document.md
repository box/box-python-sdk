...
_Currently we don't have an example for calling `get_hub_document_pages_v2025_r0` in integration tests_
...
_Currently we don't have an example for calling `get_hub_document_blocks_v2025_r0` in integration tests_
