...
> **Note:** The number of bytes uploaded for each part must be exactly `upload_sesion.part_size`, except for the last
...
[get_shared_link_download_url]: https://box-python-sdk.readthedocs.io/en/latest/boxsdk.object.html#boxsdk.object.file.File.get_shared_link_download_url
